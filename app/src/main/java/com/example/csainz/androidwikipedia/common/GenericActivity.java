...
/**
 * This Activity provides a framework that automatically handles runtime configuration changes in
 * conjunction with an instance of OpsType, which must implement the ConfigurableOps interface. It
 * also extends LifecycleLoggingActivity so that all lifecycle hook method calls are automatically
 * logged.
 */
public class GenericActivity<Interface, OpsType extends ConfigurableOps<Interface>>
     ...
     * @param opsType 
     *            Class object that's used to create an operations ("Ops") object.
     */
    ...
    public void handleConfiguration(Class<OpsType> opsType, Interface instance)
        ...
        // If this method returns true it's the first time the Activity has been created.
        if (mRetainedFragmentManager.firstTimeIn()) {
            ...
            if (mOpsInstance == null) 
                ...
                // Inform it that the runtime configuration change has completed.
