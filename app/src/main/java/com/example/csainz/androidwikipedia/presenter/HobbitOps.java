...
public class HobbitOps implements ConfigurableOps<HobbitOps.View> {
     ...
     */
    protected final static String TAG = HobbitOps.class.getSimpleName();



    /**
     * This interface defines the minimum interface needed by the HobbitOps class in the
     * "Presenter" layer to interact with the HobbitActivity in the "View" layer.
     */
     ...
     * for the HobbitOps implementation.
     */
     ...
     * CONTENT_PROVIDER_CLIENT) for the HobbitOps implementation.
     */
    private ContentProviderAccessType mAccessType;

    /**
     * Reference to the designed Concrete Implementor (i.e., either HobbitOpsContentResolver or
    ...
    /**
     * Hook method dispatched by the GenericActivity framework to initialize the HobbitOps object
    ...
    public void onConfiguration(HobbitOps.View view, boolean firstTimeIn) {
        mHobbitOpsImpl.onConfiguration(view, firstTimeIn);
    }
    ...
    /**
     * Insert a Hobbit @a character of a particular @a race into the HobbitContentProvider.
     */
    public Uri insert(String character, String race) throws RemoteException {
        return mHobbitOpsImpl.insert(character, race);
    }
    ...
    public int bulkInsert(String[] characters, String race) throws RemoteException {
        return mHobbitOpsImpl.bulkInsert(characters, race);
    }
    ...
    public int updateByUri(Uri uri, String name, String race) throws RemoteException {
        return mHobbitOpsImpl.updateByUri(uri, name, race);
    }
    ...
    public int updateRaceByName(String name, String race) throws RemoteException {
        return mHobbitOpsImpl.updateRaceByName(name, race);
    }
    ...
    public void setContentProviderAccessType(ContentProviderAccessType accessType) {
        ...
        if (mAccessType != accessType) {
            ...
            case CONTENT_RESOLVER:
                mHobbitOpsImpl = new HobbitOpsContentResolver();
                break;
            case CONTENT_PROVIDER_CLIENT:
                mHobbitOpsImpl = new HobbitOpsContentProviderClient();
                break;
            }
        }
    }
