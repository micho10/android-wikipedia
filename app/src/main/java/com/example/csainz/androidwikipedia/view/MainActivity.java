...
import com.example.csainz.androidwikipedia.presenter.HobbitOps;


/**
 * This Activity illustrates how to use the Android-Wikipedia to retrieve 10 random pages from
 * Wikipedia. This class plays the role of the "View" in the Model-View-Presenter (MVP) pattern.
 * It extends GenericActivity that provides a framework for automatically handling runtime
 ...
 * Presenter layers.
 */
public class MainActivity extends GenericActivity<HobbitOps.View, HobbitOps>
...
//    private Uri mNecromancerUri;
    ...
    /**
     * Used to display the results of contacts queried from the HobbitContentProvider.
     */
...
//        }
    ...
    /**
     * This method is run when the user clicks the "Add All" button. It inserts various characters
     * from the Hobbit book into the "database".
     */
    public void addAll(View v) {
        try {
            // Insert the main protagonist.
            getOps().insert("Bilbo", "Hobbit");

            // Insert the main wizard.
            getOps().insert("Gandalf", "Maia");

            // Insert all the dwarves.
            getOps().bulkInsert(new String[] {
                            "Thorin", "Kili", "Fili", "Balin", "Dwalin", "Oin", "Gloin", "Dori",
                            "Nori", "Ori", "Bifur", "Bofur", "Bombur"
                    },
                    "Dwarf");

            // Insert the main antagonist.
            getOps().insert("Smaug", "Dragon");

            // Insert Beorn.
            getOps().insert("Beorn", "Man");

            // Insert the Master of Laketown
            getOps().insert("Master", "Man");

            // Insert another antagonist.
//            mNecromancerUri = getOps().insert("Necromancer", "Maia");
...
//           generating a fake configuration change event. Moreover, since the HobbitOps
